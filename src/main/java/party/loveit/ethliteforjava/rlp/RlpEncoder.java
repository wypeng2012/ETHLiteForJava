package party.loveit.ethliteforjava.rlp;

import java.util.Arrays;
import java.util.List;

import static party.loveit.ethliteforjava.rlp.RlpDecoder.OFFSET_SHORT_LIST;
import static party.loveit.ethliteforjava.rlp.RlpDecoder.OFFSET_SHORT_STRING;
